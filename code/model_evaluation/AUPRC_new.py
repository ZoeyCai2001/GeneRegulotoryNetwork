...
def AUPRC(true_path='/gpfs/gibbs/pi/zhao/yw599/GRN/BEELINE-Networks/Networks/human/Non-specific-ChIP-seq-network.csv',pred_path='/gpfs/gibbs/pi/zhao/zc354/GRN/output/multiply_filename.csv',directed=True,save_path='/gpfs/gibbs/pi/zhao/zc354/GRN/output',save_name='AUPRC'):
...
AUPRC(true_path='/gpfs/gibbs/pi/zhao/yw599/GRN/BEELINE-Networks/Networks/human/Non-specific-ChIP-seq-network.csv',pred_path='/gpfs/gibbs/pi/zhao/zc354/GRN/output/multiply_filename.csv',directed=False,save_path='/gpfs/gibbs/pi/zhao/zc354/GRN/output',save_name='/AUPRC_Multi_indir')